...
namespace Calculadora
{
    public partial class Form1 : Form
    {
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            if(signo == "+")
            {
                tbpantalla.Text = Convert.ToString(InstanciadeCalculo.suma());
            }else if(signo == "-")
            {
                tbpantalla.Text = Convert.ToString(InstanciadeCalculo.resta());
            }else if(signo == "*")
            {
                tbpantalla.Text = Convert.ToString(InstanciadeCalculo.multiplicacion());
            }
            else if(signo == "/")
            {
                ...
                {
                    tbpantalla.Text = Convert.ToString(InstanciadeCalculo.division());
                }
            }
            else
            {
            ...
            InstanciadeCalculo = new calculo();
            num = null;
            signo = null; //seteo todas las variables para poder hacer un nuevo calculo limpio
